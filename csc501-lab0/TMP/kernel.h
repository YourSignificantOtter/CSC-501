...
//Nick Herrmann - Editted to add syscall counter, execution times, flag, and number sys calls
#ifndef NSYS
#define NSYS 27
#endif
extern int sysCallCounters[NPROC][NSYS];
extern unsigned long sysCallExecTimes[NPROC][NSYS];
extern Bool sysCallCounterFlag;
